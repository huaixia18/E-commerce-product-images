...
// Real gpt-image-2 output (Xiaomi Ultra cup), generated by this very pipeline.
const DEMO_TILES: PhoneTile[] = [
  { panel: "hero", state: "done", imageUrl: "/showcase/hero.webp", label: "小米 Ultra 随行杯" },
  { panel: "feature_1", state: "done", imageUrl: "/showcase/feature_1.webp", label: "316 食品级不锈钢" },
  { panel: "feature_2", state: "done", imageUrl: "/showcase/feature_2.webp", label: "莫兰迪姜黄配色" },
  { panel: "feature_3", state: "done", imageUrl: "/showcase/feature_3.webp", label: "轻量便携随行" },
  { panel: "lifestyle", state: "done", imageUrl: "/showcase/lifestyle.webp", label: "桌面场景" },
  { panel: "spec", state: "done", imageUrl: "/showcase/spec.webp" },
];
const DEMO_SPECS = [
    ...
    <section className="relative overflow-hidden">
      ...
      <div className="mx-auto max-w-6xl px-6 pt-16 pb-12 grid grid-cols-1 lg:grid-cols-[1.1fr_1fr] gap-10 items-center">
        ...
        <div className="relative">
          ...
          <PhonePreview platform="taobao" tiles={DEMO_TILES} specs={DEMO_SPECS} title="小米 Ultra 不锈钢随行杯" />
        </div>
      </div>
    </section>
  );
